...
def get_transformer():
    return Transform(in_planes=512)
...
class Stylizer(nn.Module):
    def __init__(self):
        ...
        self.decoder.load_state_dict(torch.load(WEIGHTS_FOLDER / 'decoder_iter_500000.pth'))
        self.encoder.load_state_dict(torch.load(WEIGHTS_FOLDER / 'vgg_normalised.pth'))
        self.transform.load_state_dict(torch.load(WEIGHTS_FOLDER / 'transformer_iter_500000.pth'))
